export const Hello = () => {
    return (
        <section className="flex gap-3 justify-center antialiased bg-gray-50 text-gray-600 p-4 h-max-[50vh]">
            <div className="h-full">
                <div className="max-w-xs mx-auto">
                    <div className="relative bg-indigo-700 shadow-lg rounded-lg p-5 overflow-hidden">
                        <svg
                        ...
                        <div className="relative pt-[6.25rem] pb-14">
                            ...
                            <p className="text-indigo-200">
                                ...
                                adipisicing elit. Laudantium perferendis nemo
                                optio sapiente adipisci quibusdam soluta
                                voluptates, pariatur, hic autem ullam nihil quam
                                cum tempora reiciendis voluptatum magnam, ab
                                officiis!
                            </p>
                        </div>
